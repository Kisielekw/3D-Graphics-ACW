    ...
    public class Lab3Window : GameWindow
    {
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            if(e.KeyChar == 'z')
            {
                ...
                Matrix4 inverceTranslation = Matrix4.CreateTranslation(-t);
                mGroundModel = mGroundModel * inverceTranslation * Matrix4.CreateRotationY(-0.025f) * translation;
            }
            if(e.KeyChar == 'x')
            {
                Vector3 t = mGroundModel.ExtractTranslation();
            ...
            if(e.KeyChar == 'c')
            {
                ...
                Matrix4 translation = Matrix4.CreateTranslation(t);
                Matrix4 inverceTranslation = Matrix4.CreateTranslation(-t);
                mSphereModel = mSphereModel * inverceTranslation * Matrix4.CreateRotationY(-0.025f) * translation;
            }
            if(e.KeyChar == 'v')
            {
                Vector3 t = mSphereModel.ExtractTranslation();
