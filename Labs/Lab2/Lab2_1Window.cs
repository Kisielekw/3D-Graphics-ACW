...
namespace Labs.Lab2
{
    class Lab2_1Window : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            float[] trinagleVertices = new float[] 
            { 
            ...
            uint[] triangleIndices = new uint[] { 0, 1, 2, 3, 4, 5, 6 };
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, (IntPtr)(trinagleVertices.Length * sizeof(float)), trinagleVertices, BufferUsageHint.StaticDraw);

            int size;
            GL.GetBufferParameter(BufferTarget.ArrayBuffer, BufferParameterName.BufferSize, out size);

            if (trinagleVertices.Length * sizeof(float) != size)
            {
